...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 💙 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=@CINEMA_HUB_GROUP0>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>",   
...
async def next_page(bot, query):
    ...
    if settings["button"]:
        ...
        cap = f"<b>🍀 𝗥𝗲𝗾𝘂𝗲𝘀𝘁𝗲𝗱 𝗯𝘆 🍀 : {query.from_user.mention}\n🌸𝗧𝗼𝘁𝗮𝗹 𝗥𝗲𝘀𝘂𝗹𝘁 𝗙𝗼𝘂𝗻𝗱𝗲𝗱 :- {total}\n 🎀𝗠𝗢𝗩𝗜𝗘 𝗡𝗔𝗠𝗘 : {search}\n\n⚡️ᴀʟʟ ꜰɪʟᴇꜱ ᴀʀᴇ ʜᴇʀᴇ ⚡️\n\n</b>"
        for file in files:
